...
namespace APIStudentCourse
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<dbStudentCourseContext>(o=>o.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint($"/swagger/v1/swagger.json", "StudentAp v1");
                });
            }
            app.UseStaticFiles();
